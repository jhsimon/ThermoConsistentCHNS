...
A **FreeFEM** simulation of a two-phase liquid droplet interacting with a diffuse porous obstacle. The model couples a thermodynamically consistent Cahn–Hilliard/Navier–Stokes equations, Brinkman penalization inside the obstacle, adaptive mesh refinement, and discrete energy diagnostics.
